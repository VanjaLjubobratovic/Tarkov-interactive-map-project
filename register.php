    ...
    <div class="wrapper" style ="margin: auto;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" style ="background-color:darkorange;border-style:none;" class="btn btn-primary" value="Submit">
                <input type="reset" class="btn btn-default" value="Reset">
            </div>
            <p style =" font-size:11pt">Already have an account? <a href="login.php" style = "color: orange">Login here</a>.</p>
        </form>
    </div>    
</body>
</html>